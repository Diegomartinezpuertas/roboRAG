...
| `full_system` | `use_gz_gui` (false) | Gazebo window — the most expensive thing on screen on WSL2, where it renders in software. Measured 2026-09-17 with the dashboard and RViz open: real-time factor 0.90 without it ([ADR-037](decisions/ADR-037-pay-for-the-real-time-factor.md)) |
